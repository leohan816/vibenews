...
Open READ_AND_EXECUTE directly. Read every referenced real file. Perform only the bounded rework role. Write the
declared rework result and pointer files. Return only the concise pointer block to Advisor and STOP.
```
