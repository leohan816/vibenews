...
```text
MISSION_STATE: D013_ACK_COMPATIBILITY_CORRECTION_READY_TO_ROUTE
...
D013_AUTHORIZED_DEVICE_BLOCKER: CLOSED_BY_OPERATOR_ATTESTATION
D013_REMAINING_FINDING: FUNNEL_STATUS_COMPATIBILITY
D013_ALLOWED_PRODUCT_PATHS: server/src/bin/accept-private.ts; server/test/integration/accept-private.test.ts
D013_PLANNED_REVIEW_ID: implementation-delta-review-001-a5
...
LIVE_ACCEPTANCE_COMMAND_RUN: ONE_EXIT_2
...
RELOAD_READINESS: BLOCKED_PENDING_LIVE_AND_DEVICE_ACCEPTANCE
