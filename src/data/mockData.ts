...
export const categories: Category[] = [
  {
    ...
    topKeywords: ['Agent', 'Browser', 'Claude'],
    lastUpdatedAt: '2026-07-03T06:00:00+09:00',
    hasNewItems: true,
  },
  {
    id: 'health',
...
export const todaySession: BriefingSession = {
  ...
  title: '오늘의 브리핑',
  date: '2026-07-03',
  categoryIds: ['ai', 'health', 'invest', 'skincare'],
...
export const newsAudioItems: NewsAudioItem[] = [
  {
    id: 'na1',
    newsItemId: 'ni1',
    briefingSessionId: 'bs-today',
    title: 'AI 에이전트가 브라우저를 직접 조작하기 시작했다',
    categoryId: 'ai',
    durationSec: 95,
    audioUrl: null,
    transcript: null,
    shortSummary: '에이전트가 API 없이 웹을 직접 읽고 조작하는 흐름이 커진다.',
    chapterIndex: 0,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
  },
  {
    ...
    newsItemId: 'ni2',
    briefingSessionId: 'bs-today',
    title: 'Loop Engineering이 프롬프트 엔지니어링의 다음 단계로',
    categoryId: 'ai',
    durationSec: 88,
    audioUrl: null,
    transcript: null,
    shortSummary: '검증(verification)이 오케스트레이션보다 뜨거운 주제로 떠올랐다.',
    chapterIndex: 1,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
  },
  {
    ...
    newsItemId: 'ni3',
    briefingSessionId: 'bs-today',
    title: 'Claude 계열 모델 활용 사례 확산',
    categoryId: 'ai',
    durationSec: 76,
    audioUrl: null,
    transcript: null,
    shortSummary: '개발 워크플로에 에이전트를 붙이는 사례가 늘고 있다.',
    chapterIndex: 2,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
  },
  {
    ...
    newsItemId: 'ni4',
    briefingSessionId: 'bs-today',
    title: '수면과 혈당 관리의 연결고리',
    categoryId: 'health',
    durationSec: 70,
    audioUrl: null,
    transcript: null,
    shortSummary: '수면 부족이 다음 날 혈당 반응에 영향을 준다는 연구.',
    chapterIndex: 3,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
  },
  {
    ...
    audioUrl: null,
    transcript: null,
    shortSummary: '총량이 타이밍보다 중요하다는 관점이 우세.',
    chapterIndex: 4,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
  },
  {
    ...
    newsItemId: 'ni6',
    briefingSessionId: 'bs-today',
    title: 'AI 반도체 수요와 금리 전망',
    categoryId: 'invest',
    durationSec: 82,
    audioUrl: null,
    transcript: null,
    shortSummary: 'AI 투자 사이클이 반도체 수요를 끌어올리는 중.',
    chapterIndex: 5,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
  },
  {
    ...
    newsItemId: 'ni7',
    briefingSessionId: 'bs-today',
    title: '자외선 차단과 피부장벽 관리',
    categoryId: 'skincare',
    durationSec: 60,
    audioUrl: null,
    transcript: null,
    shortSummary: '꾸준한 보습·자외선 차단이 피부장벽 회복에 중요하다는 논의.',
    chapterIndex: 6,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
...
export const todayRecap: DailyRecap = {
  ...
  timezone: 'Asia/Seoul',
  summary:
    '오늘은 AI 에이전트의 실제 인터넷 접근과 Loop Engineering 논의가 중심이었고, 건강·투자·피부관리 흐름이 함께 잡혔다.',
  keyTrends: [
    'AI 에이전트가 API 없이 웹을 직접 읽는 방향',
    '검증(verification)이 오케스트레이션보다 뜨거운 주제',
    'AI 투자 사이클이 반도체 수요를 견인',
    '피부장벽·성분 중심 스킨케어 관심 증가',
    '수면-혈당 연결 등 생활 밀착 건강 정보',
  ],
  repeatedKeywords: ['Agent', 'Verification', 'Claude', '혈당', '자외선'],
  categoryHighlights: [
...
export const savedCards: SavedCard[] = [
  {
    ...
    categoryId: 'ai',
    knowledgeType: 'Trend',
    knowledgeText: '에이전트가 API 키 없이 웹/유튜브/커뮤니티를 직접 읽는 방향으로 이동 중.',
    summary: '접근 경로가 막히면 다른 경로로 우회하는 라우팅이 관건.',
    sourceMetaIds: ['sm3', 'sm1'],
    savedAt: '2026-07-03T07:10:00+09:00',
    foundationStatus: 'candidate',
    relatedProjectIds: ['vibenews'],
  },
  {
    id: 'sc2',
    title: 'Loop Engineering 핵심',
    categoryId: 'ai',
    knowledgeType: 'Insight',
    knowledgeText: '검증이 병목이자 차별점. 오케스트레이션보다 검증 설계가 중요해진다.',
    summary: '반응은 열광과 회의가 공존.',
    sourceMetaIds: ['sm1'],
    savedAt: '2026-07-03T07:12:00+09:00',
    foundationStatus: 'local_only',
    relatedProjectIds: [],
  },
  {
    id: 'sc3',
    ...
    categoryId: 'health',
    knowledgeType: 'Fact',
    knowledgeText: '수면 부족이 다음 날 혈당 반응을 악화시킬 수 있다.',
    summary: '생활 습관 관점에서 반복 언급.',
    sourceMetaIds: ['sm4'],
    savedAt: '2026-07-01T07:15:00+09:00',
    foundationStatus: 'synced_to_foundation',
    relatedProjectIds: [],
  },
  {
    id: 'sc4',
    ...
    categoryId: 'skincare',
    knowledgeType: 'Trend',
    knowledgeText: '자외선 차단과 보습 루틴이 피부장벽 회복의 핵심이라는 정리.',
    summary: '개인화 상품 추천과 연결 여지.',
    sourceMetaIds: [],
    savedAt: '2026-06-20T07:20:00+09:00',
    foundationStatus: 'local_only',
    relatedProjectIds: [],
  },
];
...
export const exploreMores: ExploreMore[] = [
  {
    ...
    newsItemId: 'ni1',
    keyConclusion:
      '에이전트가 세상을 재료로 쓰기 시작했다. 핵심은 접근이 아니라 "막혔을 때 우회"다.',
...
export const knowledgeCandidates: KnowledgeCandidate[] = [
  {
    ...
    title: '검증이 병목',
    knowledgeType: 'Insight',
    content: '검증 설계가 에이전트 품질의 핵심 병목.',
    summary: '오케스트레이션보다 검증.',
    relatedCategoryIds: ['ai'],
    relatedProjectIds: ['vibenews'],
    relatedProductIds: [],
    sourceMetaIds: ['sm1'],
    confidenceLevel: 'medium',
    longTermValueScore: 0.8,
    userSaved: true,
    foundationStatus: 'candidate',
    knowledgeClass: 'news_knowledge',
    createdAt: '2026-07-03T07:12:00+09:00',
    reviewedAt: null,
    syncedAt: null,
  },
  {
    ...
    title: '셀프 힐링 라우팅',
    knowledgeType: 'Trend',
    content: '접근 경로가 막히면 자동으로 다음 경로로 전환하는 패턴.',
    summary: '수집 안정성의 핵심.',
    relatedCategoryIds: ['ai'],
    relatedProjectIds: ['vibenews'],
    relatedProductIds: [],
    ...
    longTermValueScore: 0.9,
    userSaved: false,
    foundationStatus: 'local_only',
    knowledgeClass: 'news_knowledge',
    createdAt: '2026-07-03T07:14:00+09:00',
    reviewedAt: null,
    syncedAt: null,
  },
];
...
export const productRecommendations: ProductRecommendation[] = [
  {
    ...
    name: '수면 보조 마그네슘(예시)',
    imageUrl: null,
    reasonKeywords: ['수면', '혈당'],
    reasonText: '오늘 들은 "수면-혈당" 주제와 연결된 관심사 기반 제품 예시입니다.',
    relatedCategoryId: 'health',
  },
  {
    id: 'pr2',
    name: '데일리 선케어(예시)',
    imageUrl: null,
    reasonKeywords: ['자외선차단', 'K-Beauty'],
    reasonText: '오늘 들은 자외선 차단·피부장벽 주제와 연결된 관심사 기반 제품 예시입니다.',
    relatedCategoryId: 'skincare',
  },
];
...
export const audioItemsForSession = (sessionId: string) =>
  newsAudioItems
    .filter((n) => n.briefingSessionId === sessionId)
