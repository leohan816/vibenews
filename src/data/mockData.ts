...
export const newsAudioItems: NewsAudioItem[] = [
  ...
  },
  {
    ...
    newsItemId: 'ni7',
    briefingSessionId: 'bs-today',
    title: 'K-Beauty 선케어 수출 증가',
    categoryId: 'kbeauty',
    durationSec: 60,
    audioUrl: null,
    transcript: null,
    shortSummary: '더마·선케어 카테고리 수출이 두 자릿수 성장.',
    chapterIndex: 6,
    isCompleted: false,
    isSaved: false,
    listenedAt: null,
...
export const todayRecap: DailyRecap = {
  ...
  timezone: 'Asia/Seoul',
  summary:
    '오늘은 AI 에이전트의 실제 인터넷 접근과 Loop Engineering 논의가 중심이었고, 건강·투자·K-Beauty 흐름이 함께 잡혔다.',
  keyTrends: [
...
export const savedCards: SavedCard[] = [
  ...
  {
    id: 'sc4',
    title: 'K-Beauty 선케어 수출',
    categoryId: 'kbeauty',
    knowledgeType: 'Trend',
    knowledgeText: '더마·선케어 카테고리 수출이 두 자릿수 성장세.',
...
export const productRecommendations: ProductRecommendation[] = [
  ...
  },
  {
    ...
    name: '데일리 선케어(예시)',
    imageUrl: null,
    reasonKeywords: ['선케어', 'K-Beauty'],
    reasonText: '오늘 들은 K-Beauty 선케어 주제와 연결된 관심사 기반 제품 예시입니다.',
    relatedCategoryId: 'kbeauty',
  },
];
